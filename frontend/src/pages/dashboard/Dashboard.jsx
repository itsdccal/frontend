...
function Navbar() {
  ...
  return (
    <header className="bg-red-500 text-white relative">
      ...
      {/* Mobile Menu */}
      {isMobileMenuOpen && (
        <div className="md:hidden bg-red-600 border-t border-red-400">
      ...
      {(isReportDropdownOpen || isMobileMenuOpen) && (
        <div 
